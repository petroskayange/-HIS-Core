...
export declare class VueWrapper<T extends ComponentPublicInstance> {
    ...
    private __app;
    private __setProps;
    private __functionalEmits;
    constructor(app: App | null, vm: ComponentPublicInstance, setProps?: (props: Record<string, any>) => void, functionalEmits?: Record<string, unknown[]>);
...
export declare function createWrapper<T extends ComponentPublicInstance>(app: App | null, vm: ComponentPublicInstance, setProps?: (props: Record<string, any>) => void, functionalComponentEmits?: Record<string, unknown[]>): VueWrapper<T>;
